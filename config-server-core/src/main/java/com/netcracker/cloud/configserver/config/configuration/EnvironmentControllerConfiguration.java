...
/**
 * Overrides Spring Cloud Config's {@code environmentController} bean
 * ({@code spring.main.allow-bean-definition-overriding=true}) with a whitespace-tolerant variant.
 * Encryption wrapping matches {@code ConfigServerMvcConfiguration}.
 */
@Configuration
